...
public class RectangleAnnotationImpl extends AnnotationImpl implements RectangleAnnotation, Serializable {
	 ...
	 */
	public RectangleAnnotationImpl() {}

	public RectangleAnnotationImpl(Date date, int score, String userId, int x, int y, int width, int height) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof RectangleAnnotation) {
			RectangleAnnotation other = (RectangleAnnotation) obj;
			boolean isRect = (
					getX() == other.getX()
					&& getY() == other.getY()
