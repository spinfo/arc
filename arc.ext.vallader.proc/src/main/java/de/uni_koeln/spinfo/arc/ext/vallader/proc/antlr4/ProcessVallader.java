...
public class ProcessVallader {
    ...
    public void cleanErrors(List<String> errorEntries) throws IOException {
        ...
        Pattern posPattern = Pattern.compile("(<E>\\s{0,3}\\p{L}{1,30})([m|f|m,f|adj/adv|adj invar/num|adj invar|adj|adv|invar/num|prep|interj|intr|intr/tr|tr ind|tr|mpl|fpl|cj|pron indef|pron pers|pron pers/refl|pron|refl|fcoll|p sg])");
