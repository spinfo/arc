...
public interface IPosTags {
	...
	public static final String[] POS_TAGS_FINAL = {
			// All forms of verb 'avair'
			"V_AVAIR",
			// All forms of verb 'esser'.
			"V_ESSER",
			// All forms of verbs pudair, stuair, vulair.
			"V_MOD",
			// Past and present participles.
			"V_PP",
			// General verb forms.
			"V_GVRB",
			// Cliticized verb forms
			"V_CLIT",
			// Common nouns
			"NN",
			// Proper nouns
			...
			// Simple prepositions.
			"PREP",
			// Prepositions fused with articles. - en + el = el (Sursilvan)
			"PREP_A",
			// Qualifying adjectives. E.g. bel 'schön'
			"ADJ",
			// Demonstrative adjectives. E.g. quest 'dieser'
			"ADJ_DIM",
			// Indefinite adjectives.E.g. betg(in) 'kein'
			"ADJ_IND",
			// Interrogative or exclamative adjectives.- E.g. con 'wie viel'
			// (Sursilvan)
			"ADJ_IES",
			// Possessive adjectives. E.g. noss 'unser'
			"ADJ_POS",
			// Numeral adjectives. E.g. erster 'prim'
			"ADJ_NUM",
			// Coordinating conjunctions. E.g. e 'und'
			"CONJ_C",
			// Subordinating conjunctions. E.g. che 'dass'
			"CONJ_S",
			// Adverbs
			"ADV",
			// Interjections
			"INT",
			// Cardinal numbers. E.g. in 'eins'
			"C_NUM",
			// Personal pronouns. E.g. jai 'ich'
			"PRON_PER",
			// Relative pronouns. e.g. che 'der', 'die, 'das'
			"PRON_REL",
			// Demonstrative pronouns. e.g. quai 'dieser'
			"PRON_DIM",
			// Indefinite pronouns. e.g mintgin 'jedermann' (Surselva)
			"PRON_IND",
			// Interrogative or exclamative pronouns. e.g. tgi 'wen'
			"PRON_IES",
			// Possessive pronouns. E.g. mias/mes 'meine'
			"PRON_POS",
			// Codes, delimiters...
			"NULL",
			// Full stop “.”, exclamative and interrogative marks “!”, “?”
			// closing a sentence.
			"P_EOS",
			// Apostrophe when used as quotation mark.
			"P_APO",
