package de.spinfo.arc.persistance.util;
...
public class PosChecker {
	...
	public static String checkIfValid(String posOption) {
		...
		throw new IllegalArgumentException("The Pos String must be equal to the String of the given PosAnnotation.PosTags strings!");
	}
}