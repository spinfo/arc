...
public class ExtractEichenhofer {
    ...
    public void extractWithPDFBOX(String outputFile) throws IOException {
        ...
        try {
            ...
            File output = new File("../antlr4.parent/eichenhofer.data/" + outputFile + "txt");
    ...
    public void extractWithIText(String outputFile) throws IOException {
        ...
        PrintWriter out = new PrintWriter(new FileOutputStream("../antlr4.parent/eichenhofer.data/" + outputFile + "txt"));
