...
public class PuterParser extends Parser {
	...
	public static class Additional_infoContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PuterListener ) ((PuterListener)listener).enterAdditional_info(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PuterListener ) ((PuterListener)listener).exitAdditional_info(this);
		}
	}
