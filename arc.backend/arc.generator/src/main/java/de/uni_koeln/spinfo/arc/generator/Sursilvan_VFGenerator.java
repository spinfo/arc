...
public class Sursilvan_VFGenerator {
	 ...
	 */
	public Map<String, TreeSet<String>> generateVollForms(DBCollection collection) throws UnknownHostException {	
	...
	private void addIrregularVerbs() {
			...
			//HAVER
			//infinitivformen
			addVF("ver", "V_AVAIR");addVF("haver", "V_AVAIR");
			// partizip perfekt
			addVF("giu", "V_AVAIR");
			// gerundium
			addGerundium("hav", VerbClass.ER, "V_AVAIR");
			// Imperativ
			addVF("hagies", "V_AVAIR");addVF("veies", "V_AVAIR");addVF("haveies", "V_AVAIR");addVF("hagien", "V_AVAIR");
			// Indikativ Präsens
			addVF("hai", "V_AVAIR");addVF("vai", "V_AVAIR");addVF("has", "V_AVAIR");addVF("ha", "V_AVAIR");addVF("havein", "V_AVAIR");addVF("vein", "V_AVAIR");addVF("haveis", "V_AVAIR");addVF("veis", "V_AVAIR");addVF("han", "V_AVAIR");
			// Indikativ Imperfekt
			addIndikativImperfekt("hav", VerbClass.ER, "V_AVAIR");addIndikativImperfekt("h", VerbClass.ER, "V_AVAIR");
			// Konjunktiv Präsens
			addVF("hagi", "V_AVAIR");addVF("hagies", "V_AVAIR");addVF("haveien", "V_AVAIR");addVF("veien", "V_AVAIR");addVF("haveies", "V_AVAIR");addVF("veies", "V_AVAIR");addVF("hagien", "V_AVAIR");
			// Konjunktiv Imperfekt
			addKonjunktivImperfekt("hav", VerbClass.ER, "V_AVAIR");addKonjunktivImperfekt("v", VerbClass.ER, "V_AVAIR");
			// konditional präsens direkt
			addKonditionalDirekt("hav", VerbClass.ER, "V_AVAIR");addKonditionalDirekt("v", VerbClass.ER, "V_AVAIR");
			// konditional präsens indirekt
			addKonditionalIndirekt("hav", VerbClass.ER, "V_AVAIR");addKonditionalIndirekt("v", VerbClass.ER, "V_AVAIR");

			//ESSER
			//infinitiv
			addVF("esser", "V_ESSER");
			// partizip perfekt
			addVF("staus", "V_ESSER");addVF("stau", "V_ESSER");addVF("stada", "V_ESSER");addVF("stai", "V_ESSER");addVF("stadas", "V_ESSER");
			// gerundium
			addGerundium("ess", VerbClass.ER, "V_ESSER");
			// imperativ
			addVF("seigies", "V_ESSER");addVF("seigien", "V_ESSER");
			// indikativ präsens
			addVF("sun", "V_ESSER");addVF("eis", "V_ESSER");addVF("ei", "V_ESSER");addVF("essan", "V_ESSER");addVF("assas", "V_ESSER");addVF("ein", "V_ESSER");
			// indikativ imperfekt
			addVF("erel", "V_ESSER");addVF("eras", "V_ESSER");addVF("era", "V_ESSER");addVF("eran", "V_ESSER");addVF("fuvel", "V_ESSER");addVF("fuvas", "V_ESSER");addVF("fuva", "V_ESSER");addVF("fuvan", "V_ESSER");
			// konjunktiv präsens
			addVF("seigi", "V_ESSER");addVF("seigies", "V_ESSER");addVF("seigien", "V_ESSER");
			// konjunktiv imperfekt
			addVF("eri", "V_ESSER");addVF("eries", "V_ESSER");addVF("erien", "V_ESSER");addVF("fuvi", "V_ESSER");addVF("fuvies", "V_ESSER");addVF("fuvien", "V_ESSER");
			// konditional präsens direkt
			addVF("fuss", "V_ESSER");addVF("fusses", "V_ESSER");addVF("fussen", "V_ESSER");
			// konditional präsens indirekt
			addVF("fussi", "V_ESSER");addVF("fussies", "V_ESSER");addVF("fussien", "V_ESSER");
			...
			addVF("vegnir", "V_GVRB");
			// kurzformen
			addVF("gnir", "V_GVRB");addVF("gnin", "V_GVRB");addVF("gnis", "V_GVRB");addVF("gneva", "V_GVRB");addVF("gnius", "V_GVRB");
			// partizip perfekt
			addVF(stamm+"ius", "V_PP");addPartizip(stamm, VerbClass.IR);
			// gerundium
			addGerundium(stamm, VerbClass.IR, "V_GVRB");		
			// imperativ
			addVF(stamm+"eu", "V_GVRB");addVF(stamm+"îen", "V_GVRB");addVF(stamm+"i", "V_GVRB");addVF(stamm+"ien", "V_GVRB");
			// indikativ präsens
			addVF(stamm+"el", "V_GVRB");addVF(stamm, "V_GVRB");addVF(stamm+"as", "V_GVRB");addVF(stamm+"s", "V_GVRB");addVF(stamm+"in", "V_GVRB");addVF(stamm+"is", "V_GVRB");addVF(stamm+"an", "V_GVRB");
			// indikativ imperfekt
			...
			// imperativ
			addVF("crei", "V_GVRB");addVF(stamm+"ei", "V_GVRB");
			// indikativ präsens
			addVF("creiel", "V_GVRB");addVF("creigel", "V_GVRB");addVF("creis", "V_GVRB");addVF("creias", "V_GVRB");addVF("crei", "V_GVRB");addVF(stamm+"ein", "V_GVRB");addVF(stamm+"eis", "V_GVRB");addVF("crein", "V_GVRB");addVF("creian", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt(stamm, VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("creigi", "V_GVRB");addVF("creigies", "V_GVRB");addVF(stamm+"eien", "V_GVRB");addVF(stamm+"eies", "V_GVRB");addVF("creigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("coi", "V_GVRB");addVF("cui", "V_GVRB");addVF("cugei", "V_GVRB");
			// indikativ präsens
			addVF("coiel", "V_GVRB");addVF("coias", "V_GVRB");addVF("cois", "V_GVRB");addVF("coi", "V_GVRB");addVF("cuin", "V_GVRB");addVF("cuis", "V_GVRB");addVF("coian", "V_GVRB");addVF("coin", "V_GVRB");addVF("cueiel", "V_GVRB");addVF("cueias", "V_GVRB");addVF("cueis", "V_GVRB");addVF("cuei", "V_GVRB");addVF("cugein", "V_GVRB");addVF("cugeis", "V_GVRB");addVF("cueian", "V_GVRB");addVF("cuein", "V_GVRB");
			// Indikativ imperfekt
			addIndikativImperfekt("cug", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("coigi", "V_GVRB");addVF("coigies", "V_GVRB");addVF("cuîen", "V_GVRB");addVF("cuîes", "V_GVRB");addVF("coigien", "V_GVRB");addVF("cueigi", "V_GVRB");addVF("cueigies", "V_GVRB");addVF("cugeien", "V_GVRB");addVF("cugeies", "V_GVRB");addVF("cueigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addVF("dar", "V_GVRB");
			// partizp perfekt
			addVF("dau", "V_PP");addVF("daus", "V_PP");addVF("dada", "V_PP");addVF("dai", "V_PP");addVF("dadas", "V_PP");
			// gerundium
			addGerundium("d", VerbClass.AR, "V_GVRB");addGerundium("d", VerbClass.IR, "V_GVRB");
			// imperativ
			addVF("dai", "V_GVRB");addVF("dei", "V_GVRB");
			// indikativ präsens
			addVF("dun", "V_GVRB");addVF("dundel", "V_GVRB");addVF("das", "V_GVRB");addVF("dat", "V_GVRB");addVF("dein", "V_GVRB");addVF("deis", "V_GVRB");addVF("dattan", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("d", VerbClass.AR, "V_GVRB");addIndikativImperfekt("d", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("detti", "V_GVRB");addVF("detties", "V_GVRB");addVF("deien", "V_GVRB");addVF("deies", "V_GVRB");addVF("dettien", "V_GVRB");
			// Konjunktiv imperfekt
			addKonjunktivImperfekt("d", VerbClass.AR, "V_GVRB");addKonjunktivImperfekt("d", VerbClass.ER, "V_GVRB");
			// Konditional präsens direkt
			addKonditionalDirekt("d", VerbClass.AR, "V_GVRB");addKonditionalDirekt("d", VerbClass.ER, "V_GVRB");	
			// konditional präsens indirekt
			addKonditionalIndirekt("d", VerbClass.AR, "V_GVRB");addKonditionalIndirekt("d", VerbClass.ER, "V_GVRB");
			...
			// imperativ
			addVF("di", "V_GVRB");addVF("schei", "V_GVRB");
			// indikativ präsnes
			addVF("ditgel", "V_GVRB");addVF("dias", "V_GVRB");addVF("dis", "V_GVRB");addVF("di", "V_GVRB");addVF("schein", "V_GVRB");addVF("scheis", "V_GVRB");addVF("dian", "V_GVRB");addVF("din", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("sch", VerbClass.IR, "V_GVRB");
			// konjunktiv präsens
			addVF("ditgi", "V_GVRB");addVF("ditgies", "V_GVRB");addVF("scheien", "V_GVRB");addVF("scheies", "V_GVRB");addVF("ditgien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addGerundium(stamm, VerbClass.ER, "V_GVRB");
			// indikativ präsens
			addVF(stamm+"ei", "V_GVRB");addVF(stamm+"eis", "V_GVRB");addVF(stamm+"ein", "V_GVRB");addVF("dei", "V_GVRB");addVF("deis", "V_GVRB");addVF("dein", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("du", VerbClass.ER, "V_GVRB");addIndikativImperfekt("d", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF(stamm+"eigi", "V_GVRB");addVF(stamm+"eigies", "V_GVRB");addVF(stamm+"eigien", "V_GVRB");addVF("deigi", "V_GVRB");addVF("deigies", "V_GVRB");addVF("deies", "V_GVRB");addVF("dei", "V_GVRB");addVF("deigien", "V_GVRB");addVF("deien", "V_GVRB");
			// Konjunktiv imperfekt
			addKonjunktivImperfekt(stamm, VerbClass.ER, "V_GVRB");addKonjunktivImperfekt("d", VerbClass.ER, "V_GVRB");
			// konditional präsens direkt
			addKonditionalDirekt(stamm, VerbClass.ER, "V_GVRB");addKonditionalDirekt("d", VerbClass.ER, "V_GVRB");
			// konditional präsens indirekt
			addKonditionalIndirekt(stamm, VerbClass.ER, "V_GVRB");addKonditionalIndirekt("d", VerbClass.ER, "V_GVRB");
			...
			// imperativ
			addVF("fai", "V_GVRB");addVF("fagei", "V_GVRB");
			// indikativ präsens
			addVF("fetsch", "V_GVRB");addVF("fetschel", "V_GVRB");addVF("fas", "V_GVRB");addVF("fa", "V_GVRB");addVF("fagein", "V_GVRB");addVF("fageis", "V_GVRB");addVF("fan", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("fag", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("fetschi", "V_GVRB");addVF("fetschies", "V_GVRB");addVF("fageien", "V_GVRB");addVF("fageies", "V_GVRB");addVF("fetschien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("fui", "V_GVRB");addVF("fugi", "V_GVRB");
			// indikativ präsens
			addVF("fuiel", "V_GVRB");addVF("fuias", "V_GVRB");addVF("fuis", "V_GVRB");addVF("fui", "V_GVRB");addVF("fugin", "V_GVRB");addVF("fugis", "V_GVRB");addVF("fuian", "V_GVRB");addVF("fuin", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("fug", VerbClass.IR, "V_GVRB");
			// konjunktiv präsens
			addVF("fuigi", "V_GVRB");addVF("fuigies", "V_GVRB");addVF("fugîen", "V_GVRB");addVF("fugîes", "V_GVRB");addVF("fuigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addVF("ir", "V_GVRB");
			// partizip perfekt
			addVF("iu", "V_PP");addVF("ida", "V_PP");addVF("i", "V_PP");addVF("idas", "V_PP");
			// gerundium
			addGerundium("m", VerbClass.AR, "V_GVRB");
			// imperativ
			addVF("va", "V_GVRB");	addVF("mei", "V_GVRB");
			// indikativ präsens
			addVF("mon", "V_GVRB");addVF("mondel", "V_GVRB");addVF("vom", "V_GVRB");addVF("vomel", "V_GVRB");addVF("vas", "V_GVRB");addVF("va", "V_GVRB");addVF("mein", "V_GVRB");addVF("meis", "V_GVRB");addVF("van", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("m", VerbClass.AR, "V_GVRB");
			// konjunktiv präsens
			addVF("mondi", "V_GVRB");addVF("mondies", "V_GVRB");addVF("meien", "V_GVRB");addVF("meies", "V_GVRB");addVF("mondien", "V_GVRB");addVF("vomi", "V_GVRB");addVF("vomies", "V_GVRB");addVF("vomien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addGerundium(stamm, VerbClass.ER, "V_GVRB");
			// indikativ präsens
			addVF("plaiel", "V_GVRB");addVF("plaias", "V_GVRB");addVF("plais", "V_GVRB");addVF("plai", "V_GVRB");addVF("plaschein", "V_GVRB");addVF("plascheis", "V_GVRB");addVF("plaian", "V_GVRB");addVF("plain", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("plasch", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("plaigi", "V_GVRB");addVF("plaigies", "V_GVRB");addVF("plascheien", "V_GVRB");addVF("plascheies", "V_GVRB");addVF("plaigien", "V_GVRB");
			// konjunktiv imperfekt
			addKonjunktivImperfekt(stamm, VerbClass.ER, "V_GVRB");
			// konditional präsens direkt
			addKonditionalDirekt(stamm, VerbClass.ER, "V_GVRB");
			...
			addVF("prui", "V_GVRB");
			// indikativ präsens
			addVF("pruiel", "V_GVRB");addVF("pruias", "V_GVRB");addVF("pruis", "V_GVRB");addVF("prui", "V_GVRB");addVF("pruin", "V_GVRB");addVF("pruian", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("prui", VerbClass.IR, "V_GVRB");
			// konjunktiv präsens
			addVF("pruigi", "V_GVRB");addVF("pruigies", "V_GVRB");addVF("pruîen", "V_GVRB");addVF("pruîes", "V_GVRB");addVF("pruigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// indikativ präsens
			addVF("pos", "V_MOD");addVF("po", "V_MOD");addVF("pudein", "V_MOD");addVF("pudeis", "V_MOD");addVF("pon", "V_MOD");
			// indikativ imperfekt
			addIndikativImperfekt("pud", VerbClass.ER, "V_MOD");
			// konjunktiv präsens
			addVF("possi", "V_MOD");addVF("possies", "V_MOD");addVF("pudeien", "V_MOD");addVF("pudeies", "V_MOD");addVF("possien", "V_MOD");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("ri", "V_GVRB");addVF("riei", "V_GVRB");
			// indikativ präsens
			addVF("riel", "V_GVRB");addVF("rias", "V_GVRB");addVF("ris", "V_GVRB");addVF("ri", "V_GVRB");addVF("riein", "V_GVRB");addVF("rieis", "V_GVRB");addVF("rian", "V_GVRB");addVF("rin", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("ri", VerbClass.IR, "V_GVRB");addVF("rievel", "V_GVRB");addVF("rievas", "V_GVRB");addVF("rieva", "V_GVRB");addVF("rievan", "V_GVRB");
			// konjunktiv präsens
			addVF("rigi", "V_GVRB");addVF("rigies", "V_GVRB");addVF("rieien", "V_GVRB");addVF("rieies", "V_GVRB");addVF("rigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("rui", "V_GVRB");addVF("ruiei", "V_GVRB");
			// indikativ präsens
			addVF("ruiel", "V_GVRB");addVF("ruias", "V_GVRB");addVF("ruis", "V_GVRB");addVF("rui", "V_GVRB");addVF("ruiein", "V_GVRB");addVF("ruin", "V_GVRB");addVF("ruieis", "V_GVRB");addVF("ruian", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("rui", VerbClass.IR, "V_GVRB");
			// konjunktiv präsens
			addVF("ruigi", "V_GVRB");addVF("ruigies", "V_GVRB");addVF("ruieien", "V_GVRB");addVF("ruieies", "V_GVRB");addVF("ruigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("sappies", "V_GVRB");addVF("saveies", "V_GVRB");
			// indikativ präsens
			addVF("sai", "V_GVRB");addVF("sas", "V_GVRB");addVF("sa", "V_GVRB");addVF("savein", "V_GVRB");addVF("saveis", "V_GVRB");addVF("san", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("sav", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("sappi", "V_GVRB");addVF("sappies", "V_GVRB");addVF("saveien", "V_GVRB");addVF("saveies", "V_GVRB");addVF("sappien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addVF("schau", "V_PP");
			// gerundium
			addGerundium("sch", VerbClass.AR, "V_GVRB");addGerundium("lasch", VerbClass.AR, "V_GVRB");
			// imperativ
			addVF("lai", "V_GVRB");addVF("schei", "V_GVRB");addVF("laschei", "V_GVRB");
			// indikativ präsens
			addVF("lasch", "V_GVRB");addVF("laias", "V_GVRB");addVF("lais", "V_GVRB");addVF("lai", "V_GVRB");addVF("schein", "V_GVRB");addVF("scheis", "V_GVRB");addVF("laian", "V_GVRB");addVF("lain", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("lasch", VerbClass.AR, "V_GVRB");addIndikativImperfekt("sch", VerbClass.AR, "V_GVRB");
			// konjunktiv präsens
			addVF("laschi", "V_GVRB");addVF("laschies", "V_GVRB");addVF("lascheien", "V_GVRB");addVF("scheien", "V_GVRB");addVF("lascheies", "V_GVRB");addVF("scheies", "V_GVRB");addVF("laschien", "V_GVRB");
			// konjunktiv imperfekt
			addKonjunktivImperfekt("lasch", VerbClass.AR, "V_GVRB");addKonjunktivImperfekt("sch", VerbClass.AR, "V_GVRB");
			// konditional präsens direkt
			addKonditionalDirekt("lasch", VerbClass.AR, "V_GVRB");addKonditionalDirekt("sch", VerbClass.AR, "V_GVRB");addVF("schess", "V_GVRB");addVF("schesses", "V_GVRB");addVF("schessen", "V_GVRB");
			// konditional präsens indirekt
			addKonditionalIndirekt("lasch", VerbClass.AR, "V_GVRB");addKonditionalIndirekt("sch", VerbClass.AR, "V_GVRB");addVF("schond", "V_GVRB");addVF("schessi", "V_GVRB");addVF("schessies", "V_GVRB");addVF("schessien", "V_GVRB");
			...
			// imperativ
			addVF("schai", "V_GVRB");addVF("schischei", "V_GVRB");
			// indikativ präsens
			addVF("schaiel", "V_GVRB");addVF("schaias", "V_GVRB");addVF("schais", "V_GVRB");addVF("schai", "V_GVRB");addVF("schischein", "V_GVRB");addVF("schischeis", "V_GVRB");addVF("schaian", "V_GVRB");addVF("schain", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("schisch", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("schaigi", "V_GVRB");addVF("schaigies", "V_GVRB");addVF("schischeien", "V_GVRB");addVF("schischeies", "V_GVRB");addVF("schaigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			// imperativ
			addVF("sfoi", "V_GVRB");addVF("sfuiei", "V_GVRB");
			// indikativ präsens
			addVF("sfoiel", "V_GVRB");addVF("sfoias", "V_GVRB");addVF("sfois", "V_GVRB");addVF("sfoi", "V_GVRB");addVF("sfuiein", "V_GVRB");addVF("sfuieis", "V_GVRB");addVF("sfoian", "V_GVRB");addVF("sfoin", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("sfui", VerbClass.IR, "V_GVRB");
			// konjunktiv präsens
			addVF("sfoigi", "V_GVRB");addVF("sfoigies", "V_GVRB");addVF("sfuieien", "V_GVRB");addVF("sfuieies", "V_GVRB");addVF("sfoigien", "V_GVRB");
			// konjunktiv imperfekt
			...
			addVF("star", "V_GVRB");
			// partizp perfekt
			addVF("stau", "V_PP");addVF("staus", "V_PP");addVF("stada", "V_PP");addVF("stai", "V_PP");addVF("stadas", "V_PP");
			// gerundium
			addGerundium("st", VerbClass.AR, "V_GVRB");addGerundium("st", VerbClass.ER, "V_GVRB");
			// imperativ
			addVF("stai", "V_GVRB");addVF("stei", "V_GVRB");
			// indikativ präsens
			addVF("stun", "V_GVRB");addVF("stundel", "V_GVRB");addVF("stas", "V_GVRB");addVF("stat", "V_GVRB");addVF("stein", "V_GVRB");addVF("steis", "V_GVRB");addVF("stattan", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("st", VerbClass.AR, "V_GVRB");addIndikativImperfekt("st", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("stetti", "V_GVRB");addVF("stetties", "V_GVRB");addVF("steien", "V_GVRB");addVF("steies", "V_GVRB");addVF("stettien", "V_GVRB");
			// Konjunktiv imperfekt
			addKonjunktivImperfekt("st", VerbClass.AR, "V_GVRB");addKonjunktivImperfekt("st", VerbClass.ER, "V_GVRB");
			// Konditional präsnes direkt
			addKonditionalDirekt("st", VerbClass.AR, "V_GVRB");addKonditionalDirekt("st", VerbClass.ER, "V_GVRB");
			// konditional präsens indirekt
			addKonditionalIndirekt("st", VerbClass.AR, "V_GVRB");addKonditionalIndirekt("st", VerbClass.ER, "V_GVRB");
			...
			// indikativ präsens
			addVF("stoi", "V_MOD");addVF("sto", "V_MOD");addVF("stos", "V_MOD");addVF("stuein", "V_MOD");addVF("stueis", "V_MOD");addVF("ston", "V_MOD");
			// indikativ imperfekt
			addIndikativImperfekt("stu", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("stoppi", "V_MOD");addVF("stoppies", "V_MOD");addVF("stueien", "V_MOD");addVF("stueies", "V_MOD");addVF("stoppien", "V_MOD");
			// Konjunktiv imperfekt
			...
			// imperativ
			addVF("trai", "V_GVRB");addVF("tila", "V_GVRB");addVF("targei", "V_GVRB");
			// indikativ präsens
			addVF("traiel", "V_GVRB");addVF("trai", "V_GVRB");addVF("trais", "V_GVRB");addVF("targein", "V_GVRB");addVF("targeis", "V_GVRB");addVF("train", "V_GVRB");addVF("tilel", "V_GVRB");addVF("tilas", "V_GVRB");addVF("tila", "V_GVRB");addVF("tilan", "V_GVRB");
			// indikativ imperfekt
			addIndikativImperfekt("targ", VerbClass.ER, "V_GVRB");
			// konjunktiv präsens
			addVF("traigi", "V_GVRB");addVF("traigies", "V_GVRB");addVF("targeien", "V_GVRB");addVF("targeies", "V_GVRB");addVF("tragien", "V_GVRB");addVF("tili", "V_GVRB");addVF("tilies", "V_GVRB");addVF("tilien", "V_GVRB");
			// Konjunktiv imperfekt
			...
			// imperativ
			addVF("veglies", "V_MOD");addVF("vuleies", "V_MOD");
			// indikativ präsens
			addVF("vi", "V_MOD");addVF("vul", "V_MOD");addVF("vulein", "V_MOD");addVF("lein", "V_MOD");addVF("vuleis", "V_MOD");addVF("leis", "V_MOD");addVF("vulan", "V_MOD");
			// indikativ imperfekt
			addIndikativImperfekt("vul", VerbClass.ER, "V_MOD");addIndikativImperfekt("l", VerbClass.ER, "V_MOD");
			// konjunktiv präsens
			addVF("vegli", "V_MOD");addVF("veglies", "V_MOD");addVF("vuleien", "V_MOD");addVF("leien", "V_MOD");addVF("vuleies", "V_MOD");addVF("leies", "V_MOD");addVF("veglien", "V_MOD");
			// Konjunktiv imperfekt
			addKonjunktivImperfekt("vul", VerbClass.ER, "V_MOD");addKonjunktivImperfekt("l", VerbClass.ER, "V_MOD");
			// Konditional präsnes direkt
			addKonditionalDirekt("vul", VerbClass.ER, "V_MOD");addKonditionalDirekt("l", VerbClass.ER, "V_MOD");
			// konditional präsens indirekt
			addKonditionalIndirekt("vul", VerbClass.ER, "V_MOD");addKonditionalDirekt("l", VerbClass.ER, "V_MOD");
	}
