...
public class SursilvanTest {
    ...
    private static Map<String, TreeSet<String>> readFullForms(String fileName) throws Exception {
    ...
    private static <K, V> void writeFullforms(Map<K, V> fullForms) throws IOException {
        ...
        ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(FileUtils.outputPath + "fullforms_" + FileUtils.getISO8601StringForCurrentDate()));
