...
public class NVSParser extends Parser {
	...
	public NVSParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class StartSymbContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(NVSParser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterStartSymb(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitStartSymb(this);
		}
	}
	...
	public static class EntryContext extends ParserRuleContext {
		public TerminalNode OPENINGTAG() { return getToken(NVSParser.OPENINGTAG, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterEntry(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitEntry(this);
		}
	}
	...
	public static class ErrorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterError(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitError(this);
		}
	}
	...
	public static class LemmaContext extends ParserRuleContext {
		public List<TerminalNode> TOKEN() { return getTokens(NVSParser.TOKEN); }
		public TerminalNode TOKEN(int i) {
			return getToken(NVSParser.TOKEN, i);
		}
		public TerminalNode POS() { return getToken(NVSParser.POS, 0); }
		public NgeContext nge() {
			return getRuleContext(NgeContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterLemma(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitLemma(this);
		}
	}
	...
	public static class EndEntryContext extends ParserRuleContext {
		public TerminalNode CLOSINGTAG() { return getToken(NVSParser.CLOSINGTAG, 0); }
		public TerminalNode LINEBREAK() { return getToken(NVSParser.LINEBREAK, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterEndEntry(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitEndEntry(this);
		}
	}
	...
	public static class NgeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).enterNge(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof NVSListener ) ((NVSListener)listener).exitNge(this);
		}
	}
