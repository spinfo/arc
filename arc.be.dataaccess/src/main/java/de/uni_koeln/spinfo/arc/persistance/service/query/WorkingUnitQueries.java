package de.uni_koeln.spinfo.arc.persistance.service.query;
...
public class WorkingUnitQueries {
	...
	public List<de.uni_koeln.spinfo.arc.annotationmodel.annotatable.WorkingUnit> getWorkingUnitsWithLanguage(String language) {
