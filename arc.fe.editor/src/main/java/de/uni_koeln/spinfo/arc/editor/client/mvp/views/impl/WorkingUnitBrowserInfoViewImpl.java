...
import de.uni_koeln.spinfo.arc.editor.client.mvp.presenter.WorkingUnitBrowserInfoViewPresenter;
import de.uni_koeln.spinfo.arc.editor.client.mvp.views.WorkingUnitBrowserInfoView;

public class WorkingUnitBrowserInfoViewImpl extends Composite implements
		WorkingUnitBrowserInfoView {
	...
	public void clearHeaderPanelWidgets() {
		for (Iterator<Widget> iterator = horizontalHeaderPanel.iterator(); iterator
				.hasNext();) {
	...
	public void clearContentPanelWidgets() {
		...
		// int widgetCount = 0;
		// for (Iterator<Widget> iterator = verticalContentPanel.iterator();
		// iterator.hasNext();) {
		// Widget widget = (Widget) iterator.next();
		// widgetCount++;
		// if (!(widget instanceof Label)) {
