...
public class EichenhoferLexer extends Lexer {
	...
	private static final String[] _LITERAL_NAMES = {
		null, "'<E>'", "'</E>'", null, null, null, "'['", "'('", "']'", "')'", 
		null, null, null, null, "'-'", "'.'", "'!'", "'?'", "'''", null, "'#'", 
		"','", "'*'", "';'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, "OPENINGTAG", "CLOSINGTAG", "POS", "EI", "RN", "OSP", "OCP", "CSP", 
		"CCP", "PAR", "LINEBREAK", "COMPLEXTOKEN", "INT", "S", "DOT", "EXK", "QM", 
		"AP", "ED", "R", "COMMA", "AST", "SEMICOLON", "WS", "ErrorChar"
	};
