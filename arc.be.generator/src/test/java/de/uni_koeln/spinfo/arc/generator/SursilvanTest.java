...
public class SursilvanTest {
    ...
    public void testMatchTokensSerialized() throws Exception {
        ...
        Map<String, TreeSet<String>> fullForms = FileUtils.readFullForms("fullforms_2015-02-03T19:54:07Z");

        POSMatcher matcher = new SursilvanMatcher(fullForms,
                nvs_collection.getFullName());
        matcher.configure(new Boolean[]{true, true, true, true});

        List<Token> sursilvanTokens = getListOfTokens(pathToTokensFromDB);

        ArrayList<Token> matches = (ArrayList<Token>) matcher
                .matchTokensWithPOS(sursilvanTokens, "sursilvan");
    ...
    public void testGetPOS() throws Exception {
        ...
        Map<String, TreeSet<String>> fullForms = FileUtils.readFullForms("fullforms_2015-01-22T14:41:27Z");
