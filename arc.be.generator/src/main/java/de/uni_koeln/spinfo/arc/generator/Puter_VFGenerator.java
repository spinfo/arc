...
//			addVF("'ls", "PRON_PER");
    ...
    private void addIrregularVerbs() {
        ...
        addVF("eira", "V_ESSER");
        addVF("d'eira", "V_ESSER");
        addVF("eirans", "V_ESSER");
        addVF("d'eirans", "V_ESSER");
        addVF("eiras", "V_ESSER");
        addVF("d'eiras", "V_ESSER");
        addVF("eiran", "V_ESSER");
        addVF("d'eiran", "V_ESSER");
        // Indikativ passo definieu
        addVF("füt", "V_ESSER");
        addVF("füttast", "V_ESSER");
        addVF("füttans", "V_ESSER");
        addVF("füttas", "V_ESSER");
        addVF("füttan", "V_ESSER");
        // Indikativ Futur I
        addVF("saro", "V_ESSER");
        addVF("sarost", "V_ESSER");
        addVF("sarons", "V_ESSER");
        addVF("saros", "V_ESSER");
        addVF("saron", "V_ESSER");
        // Indikativ futur dubitativ
        addVF("saregia", "V_ESSER");
        addVF("saregiast", "V_ESSER");
        addVF("saregians", "V_ESSER");
        addVF("saregias", "V_ESSER");
        addVF("saregian", "V_ESSER");
        // Konjunktiv Präsens
        addVF("saja", "V_ESSER");
        addVF("sajast", "V_ESSER");
        addVF("sajans", "V_ESSER");
        ...
        addVF("füssans", "V_ESSER");
        addVF("füssas", "V_ESSER");
        ...
        // Imperativ
        addVF("hegiast", "V_AVAIR");
        addVF("hegians", "V_AVAIR");
        addVF("hegias", "V_AVAIR");
        addVF("hegia", "V_AVAIR");
        addVF("hegian", "V_AVAIR");
        // Indikativ Präsens
        addVF("d'he", "V_AVAIR");
        addVF("hest", "V_AVAIR");
        addVF("ho", "V_AVAIR");
        ...
        // Imperativ
        addVF("vo", "V_GVRB");
        addVF("giainsa", "V_GVRB");
        addVF("gè", "V_GVRB");
        addVF("gaijan", "V_GVRB");
        stamm = "vo";
        addVF(stamm + "'m", "V_GVRB");
        addVF(stamm + "'l", "V_GVRB");
        addVF(stamm + "'ns", "V_GVRB");
        addVF(stamm + "'ls", "V_GVRB");
        // Indikativ Präsens
        addVF("vegn", "V_GVRB");
        addVF("vest", "V_GVRB");
        addVF("vo", "V_GVRB");
        ...
        addVF("dist", "V_GVRB");
        addVF("disch", "V_GVRB");
        addVF("dschains", "V_GVRB");
        addVF("dschais", "V_GVRB");
        addVF("dian", "V_GVRB");
        // Indikativ Imperfekt
        stamm = "dsch";
        ...
        addVF("fè", "V_MOD");
        addVF("fatscha", "V_MOD");
        addVF("fatschan", "V_MOD");
        stamm = "fo";
        addVF(stamm + "'m", "V_MOD");
        addVF(stamm + "'l", "V_MOD");
        addVF(stamm + "'ns", "V_MOD");
        addVF(stamm + "'ls", "V_MOD");
        // Indikativ Präsens
        addVF("fatsch", "V_MOD");
        addVF("fest", "V_MOD");
        addVF("fo", "V_MOD");
        ...
        addVF("solaiva", "V_GVRB");
        addVF("solaivans", "V_GVRB");
        addVF("solaivas", "V_GVRB");
        addVF("solaivan", "V_GVRB");
        // Konjunktiv Präsens
        addVF("soula", "V_GVRB");
        addVF("soulast", "V_GVRB");
        addVF("soulans", "V_GVRB");
        addVF("soulas", "V_GVRB");
        addVF("soulan", "V_GVRB");
        addVF("solaivan", "V_GVRB");
    ...
    private void dür(String prefix) {
        ...
        //Imperativ
        addVF(prefix + "via", "V_GVRB");
        addImperativ(stamm, VerbClass.ER, "V_GVRB");
        //Indikativ Präsens
        addVF(prefix + "vignt", "V_GVRB");
        addVF(prefix + "vegn", "V_GVRB");
        addVF(prefix + "veans", "V_GVRB");
        addVF(prefix + "vean", "V_GVRB");
        addVF(stamm + "agn", "V_GVRB");
        addVF(stamm + "ez", "V_GVRB");
        addVF(prefix + "vignan", "V_GVRB");
        addVF(prefix + "vegnan", "V_GVRB");
        //Indikativ Imperfekt
        addIndikativImperfekt(stamm, VerbClass.ER, "V_GVRB");
        //Konjunktiv Präsens
        addVF(prefix + "vigni", "V_GVRB");
        addVF(prefix + "vignias", "V_GVRB");
        addVF(prefix + "vignas", "V_GVRB");
        addVF(stamm + "eian", "V_GVRB");
        addVF(stamm + "eias", "V_GVRB");
        addVF(stamm + "evan", "V_GVRB");
        //Konjunktiv Imperfekt
        addKonjunktivImperfekt(stamm, VerbClass.ER, "V_GVRB");
    }
